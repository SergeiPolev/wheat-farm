public static class LayerManager
{
    ...
    public static int GrassLayer = 7;
    public static int GrassChunkLayer = 8;
    ...
    public static int GrassLayerMask = 1 << GrassLayer;
    public static int GrassChunkLayerMask = 1 << GrassChunkLayer;
    ...
    public static int AllObstaclesLayerMask = GrassLayerMask;
